...
Looks above the current pixel for the next boundary pixel.
Used by get_theo_neighbourhood.
"""


def up_look(trace_region, current_px, current_py, prev, truth):
    """
    Check 3 pixels above for a boundary continuation.
